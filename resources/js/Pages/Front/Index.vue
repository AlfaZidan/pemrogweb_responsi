...
<template>
  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
      <a href="https://www.instagram.com/alfazidan_/" class="flex items-center">
        <img src="../../Components/images/logo.png" class="h-8 mr-3" alt="dOmba" />
      </a>
      <button
        ...
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
          ...
          <li>
            <div v-if="canLogin">
              ...
              <template v-else>
                <Link :href="route('login')" type="button" class="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0"> Log in</Link>
              </template>
            </div>
          </li>
        </ul>
    ...
    <div class="container px-5 py-5">
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <h1 class="font-bold text-6xl py-5 text-blue-600">
            NontonKuy
          </h1>
          <p>
            "NontonKuy" is an online platform that allows you to watch movies or series wherever you are, when you need to be in a good mood.
          </p>
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            <button type="button" class="bg-blue-500 hover:bg-blue-400 text-white rounded-lg px-4 py-2 mt-7">
            Login <i class="fas fa-arrow-right" style="margin-left: 8px;"></i>
            </button>
            <button type="button" class="bg-gray-100 hover:bg-blue-400 text-black rounded-lg px-4 py-2 mt-7 border-grey-500 border-2">Know More</button>
          </div>
        </div>
        <div class="lg:w-6/12">
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            ...
            <span class="self-center text-2xs font-semibold whitespace-wrap text-black ">
            "Entertainment Anywhere" - Experience the joy of "NontonKuy," your go-to online platform for movies and series. Enjoy on-the-go streaming to uplift your mood wherever you are.</span>
          </div>
        </div>
