      ...
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          ...
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            <button type="button" class="bg-blue-500 hover:bg-blue-400 text-white  rounded-lg px-4 py-2 mt-7">Primary</button>
            <button type="button" class="bg-gray-300 hover:bg-gray-200 text-white rounded-lg px-4 py-2 mt-7">Default</button>
          </div>
        </div>
        <div class="lg:w-6/12">
